...
namespace System.Data.Bindings.Collections.Generic
{
	...
	/// </summary>
	public class GenericObservableFilterListView <T> : BaseGenericClientObservableListView<T>, IList<T>, IEnumerable<T>, IObservableList, IFiltered
	{
...
/*			if (aSender == null)
		...
		private GenericObservableFilterListView()
			: base (null)
		{
		}
		
		public GenericObservableFilterListView (IList<T> aParentList)
			: base (aParentList)
		{
		}
	}
