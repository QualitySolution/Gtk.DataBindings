...
{	
	...
	/// </summary>
	public class BaseGenericClientObservableListView <T> : BaseNotifyPropertyChanged, IObservableListClient<T>
	{
		private IList<T> parentView = null;
		/// <value>
		/// Parent list
		/// </value>
		public IList<T> ParentView {
		...
		private BaseGenericClientObservableListView()
			: this (null)
		{
		}
		...
		~BaseGenericClientObservableListView()
		{
			Disconnect();
		}
	}
