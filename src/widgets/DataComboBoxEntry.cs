// DataComboBoxEntry.cs - DataComboBoxEntry implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataComboBoxEntry : ComboBoxEntry, IAdaptableListControl, IPostableControl, IAdaptableControl
	{
...
//			cachedItems = null;
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataComboBoxEntry (object aDataSource, string aMappings)
			: base()
		{
			internalModel = new MappingsImplementor (this);
			CreateAdaptors();
