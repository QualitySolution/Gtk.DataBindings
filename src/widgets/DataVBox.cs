// DataVBox.cs - DataVBox implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataVBox : VBox, IAdaptableContainer, IContainerControl
	{
		...
		/// Mappings with this container <see cref="System.String"/>
		/// </param>
		public DataVBox (object aDataSource, string aMappings)
			: base()
		{
