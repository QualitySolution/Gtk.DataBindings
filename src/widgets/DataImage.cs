// DataImage.cs - DataImage implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataImage : Image, IAdaptableControl, IPostableControl
	{
		/// <summary>
...
//				wdg = new DataEntry();
		...
		/// </param>
		public DataImage (string aMappings)
			: base ()
		{
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataImage (object aDataSource, string aMappings)
			: base ()
		{
