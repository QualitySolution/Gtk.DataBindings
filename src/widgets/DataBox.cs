// DataBox.cs - DataBox implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	/// </summary>
	public class DataBox : Box, IAdaptableContainer, IContainerControl
	{
		...
		/// Mappings with this container <see cref="System.String"/>
		/// </param>
		public DataBox (object aDataSource, string aMappings)
			: base()
		{
