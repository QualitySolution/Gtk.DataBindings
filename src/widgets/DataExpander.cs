// DataExpander.cs - DataExpander implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataExpander : Expander, IAdaptableContainer, IContainerControl, ICustomGetData
	{
		...
		/// Creates Container
		/// </summary>
		public DataExpander (System.IntPtr aRaw)
			: base (aRaw)
		{
		...
		/// </summary>
		/// <param name="aName">
		/// Label string for this container <see cref="System.String"/>
		/// </param>
		public DataExpander (string aName)
			: base (aName)
		{
			adaptor = new GtkControlAdaptor (this, true);
			Added += NotifyAdaptorsOnAdd;
		...
		/// </param>
		public DataExpander (string aName, string aMappings)
			: base (aName)
		{
		...
		/// Mappings with this container <see cref="System.String"/>
		/// </param>
		public DataExpander (string aName, object aDataSource, string aMappings)
			: base (aName)
		{
