// DataFixed.cs - DataFixed implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	/// </summary>
	public class DataFixed : Fixed, IAdaptableContainer, IContainerControl
	{
		...
		/// </param>
		public DataFixed (string aMappings)
			: base()
		{
