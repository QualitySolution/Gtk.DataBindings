// DataFileChooserWidget.cs - DataFileChooserWidget implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataFileChooserWidget : FileChooserWidget, IAdaptableControl, IPostableControl
	{
		...
		/// </param>
		/// <param name="aMapping">
		/// Mapping changed <see cref="System.String"/>
		/// </param>
		...
		/// </param>
		public DataFileChooserWidget (System.IntPtr aRaw)
			: base (aRaw)
		{
			adaptor = new GtkControlAdaptor (this, false);
		}
		...
		/// </param>
		public DataFileChooserWidget (FileChooserAction aAction, string aMappings)
			: base (aAction)
		{
