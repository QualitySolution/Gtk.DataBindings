// DataHScale.cs - DataHScale implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataHScale : HScale, IAdaptableControl, IPostableControl
	{
		...
		/// </param>
		public DataHScale (int aMin, int aMax, int aStep)
...
//			adaptor.SetValueMapping ("Value");
		...
		/// </param>
		public DataHScale (int aMin, int aMax, int aStep, string aMappings)
			: base (aMin, aMax, aStep)
		{
...
//			adaptor.SetValueMapping ("Value");
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataHScale (int aMin, int aMax, int aStep, object aDataSource, string aMappings)
			: base (aMin, aMax, aStep)
		{
