// DataBin.cs - DataBin implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	/// </summary>
	public class DataBin : Bin, IAdaptableContainer, IContainerControl
	{
		...
		/// </param>
		public DataBin (string aMappings)
			: base()
		{
		...
		/// Mappings with this container <see cref="System.String"/>
		/// </param>
		public DataBin (object aDataSource, string aMappings)
			: base()
		{
