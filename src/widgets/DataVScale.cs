// DataVScale.cs - DataVScale implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataVScale : VScale, IAdaptableControl, IPostableControl
	{
...
//			adaptor.SetValueMapping ("Value");
		...
		/// </param>
		public DataVScale (int aMin, int aMax, int aStep, string aMappings)
			: base (aMin, aMax, aStep)
		{
