// DataColorSelection.cs - DataColorSelection implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataColorSelection : ColorSelection, IAdaptableControl, IPostableControl
	{
		...
		public virtual void GetDataFromDataSource (object aSender)
		{
			...
			if ((col.Blue == CurrentColor.Blue) && (col.Green == CurrentColor.Green) &&
			    (col.Pixel == CurrentColor.Pixel) && (col.Red == CurrentColor.Red))
				return;
//			if ((col.Blue != CurrentColor.Blue) || (col.Green != CurrentColor.Green) || 
//			    (col.Pixel != CurrentColor.Pixel) || (col.Red != CurrentColor.Red))
			CurrentColor = (Gdk.Color) adaptor.Value;
		}
		...
		/// </param>
		public DataColorSelection (string aMappings)
			: base()
		{
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataColorSelection (object aDataSource, string aMappings)
			: base()
		{
