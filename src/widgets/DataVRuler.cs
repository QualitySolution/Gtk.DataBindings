// DataVRuler.cs - DataVRuler implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataVRuler : VRuler, IAdaptableControl
	{
...
//			adaptor.SetValueMapping ("Position");
		...
		/// </param>
		public DataVRuler (string aMappings)
			: base()
		{
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataVRuler (object aDataSource, string aMappings)
			: base()
		{
