// DataToolbar.cs - DataToolbar implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataToolbar : Toolbar, IAdaptableContainer, IContainerControl
	{
		...
		/// </summary>
		[Browsable (true), Category ("Data Binding")]
		...
		/// </param>
		public DataToolbar (string aMappings)
			: base()
		{
		...
		/// Mappings with this container <see cref="System.String"/>
		/// </param>
		public DataToolbar (object aDataSource, string aMappings)
			: base()
		{
