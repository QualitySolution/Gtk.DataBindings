// DataTable.cs - DataTable implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataTable : Table, IAdaptableContainer, IContainerControl
	{
		...
		/// </summary>
		/// <param name="aRaw">
		/// Gtk pointer <see cref="System.IntPtr"/>
		/// </param>
		public DataTable (System.IntPtr aRaw)
			: base (aRaw)
		{
		...
		/// </summary>
		/// <param name="aRows">
		/// Rows in table <see cref="System.UInt32"/>
		/// </param>
		/// <param name="aColumns">
		/// Columns in table <see cref="System.UInt32"/>
		/// </param>
		/// <param name="aHomogeneous">
		/// Cells are homogeneous <see cref="System.Boolean"/>
		/// </param>
		public DataTable (uint aRows, uint aColumns, bool aHomogeneous)
			: base (aRows, aColumns, aHomogeneous)
		{
			adaptor = new GtkControlAdaptor (this, true);
			Added += NotifyAdaptorsOnAdd;
		}
		...
		/// </param>
		public DataTable (uint aRows, uint aColumns, bool aHomogeneous, string aMappings)
			: base (aRows, aColumns, aHomogeneous)
		{
		...
		/// Mappings with this container <see cref="System.String"/>
		/// </param>
		public DataTable (uint aRows, uint aColumns, bool aHomogeneous, object aDataSource, string aMappings)
			: base (aRows, aColumns, aHomogeneous)
		{
