// DataTextView.cs - DataTextView implementation for Gtk#Databindings
//
// Author: tadey <tadej@arsis.net>
//
	...
	public class DataTextView : TextView, IAdaptableControl, ICustomDataEvents, IPostableControl
	{
		...
		public virtual void PutDataToDataSource (object aSender)
		{
			...
			if (adaptor.ValueType != typeof(string))
				return;
			if ((string)adaptor.Value != Buffer.Text)
				adaptor.Value = Buffer.Text;
		}
		...
		/// </param>
		public DataTextView (string aMappings)
			: base()
		{
