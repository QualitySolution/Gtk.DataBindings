// DataDrawingArea.cs - DataDrawingArea implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataDrawingArea : DrawingArea, IAdaptableControl, IPostableControl
	{
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataDrawingArea (object aDataSource, string aMappings)
			: base()
		{
