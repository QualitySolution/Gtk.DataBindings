// DataRadioButton.cs - DataRadioButton implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataRadioButton : RadioButton, IAdaptableControl, IPostableControl
	{
		...
		/// Creates Widget 
		/// </summary>
		public DataRadioButton (string aLabel)
			: base (aLabel)
		{
		...
		/// </param>
		public DataRadioButton (string aLabel, string aMappings)
			: base (aLabel)
		{
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataRadioButton (string aLabel, object aDataSource, string aMappings)
			: base (aLabel)
		{
