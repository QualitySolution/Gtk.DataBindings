// DataFileChooserButton.cs - DataFileChooserButton implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataFileChooserButton : FileChooserButton, IAdaptableControl, IPostableControl
	{
		...
		public virtual void GetDataFromDataSource (object aSender)
		{
			...
			CurrentName = (string) adaptor.Value;
		}
		...
		/// </summary>
		/// <param name="aDialog">
		/// Dialog associated with this widget <see cref="Widget"/>
		/// </param>
		public DataFileChooserButton (Widget aDialog)
			: base (aDialog)
		{
		...
		/// </summary>
		/// <param name="aRaw">
		/// Raw pointer <see cref="System.IntPtr"/>
		/// </param>
		public DataFileChooserButton (System.IntPtr aRaw)
			: base (aRaw)
		{
			adaptor = new GtkControlAdaptor (this, false);
		}
		...
		/// </param>
		public DataFileChooserButton (string aTitle, FileChooserAction aAction)
			: base (aTitle, aAction)
		{
			adaptor = new GtkControlAdaptor (this, false);
		}
		...
		/// </param>
		public DataFileChooserButton (string aTitle, FileChooserAction aAction, string aMappings)
			: base (aTitle, aAction)
		{
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataFileChooserButton (string aTitle, FileChooserAction aAction, object aDataSource, string aMappings)
			: base (aTitle, aAction)
		{
