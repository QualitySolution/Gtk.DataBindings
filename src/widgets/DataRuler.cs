// DataRuler.cs - DataRuler implementation for Gtk#Databindings
//
...
namespace Gtk.DataBindings
{
	...
	public class DataRuler : Ruler, IAdaptableControl
	{
...
//			adaptor.SetValueMapping ("Position");
		...
		/// Mappings with this widget <see cref="System.String"/>
		/// </param>
		public DataRuler (object aDataSource, string aMappings)
			: base()
		{
