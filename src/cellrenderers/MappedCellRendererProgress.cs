...
namespace Gtk.DataBindings
{
	...
	/// how it is mapped
	/// </summary>
	[GtkCellFactoryProvider ("percent", "DefaultFactoryCreate")]
	[GtkCellFactoryProvider ("progress", "DefaultFactoryCreate")]
	public class MappedCellRendererProgress : CellRendererProgress, IMappedColumnItem
	{
		/// <summary>
		...
		public static IMappedColumnItem DefaultFactoryCreate (FactoryInvocationArgs aArgs)
		{
			...
			if (aArgs.State == PropertyDefinition.ReadOnly)
				wdg = new MappedCellRendererProgress();
			else
				wdg = new MappedCellRendererProgress();
