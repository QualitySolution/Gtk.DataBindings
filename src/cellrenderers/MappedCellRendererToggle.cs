...
namespace Gtk.DataBindings
{
	...
	/// how it is mapped
	/// </summary>
	[GtkCellFactoryProvider ("bool", "DefaultFactoryCreate")]
	[GtkTypeCellFactoryProvider ("boolhandler", "DefaultFactoryCreate", typeof(bool))]
	public class MappedCellRendererToggle : CellRendererToggle, IMappedColumnItem
	{
		/// <summary>
		...
		{
			MappedCellRendererToggle wdg = new MappedCellRendererToggle();
			if (aArgs.State == PropertyDefinition.ReadWrite)
				wdg.Activatable = true;
