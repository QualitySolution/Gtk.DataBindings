...
namespace Gtk.DataBindings
{
	...
	/// how it is mapped
	/// </summary>
	[GtkCellFactoryProvider ("number", "DefaultFactoryCreate")]
	[GtkTypeCellFactoryProvider ("inthandler", "DefaultFactoryCreate", typeof(int))]
	[GtkTypeCellFactoryProvider ("floathandler", "DefaultFactoryCreate", typeof(float))]
	[GtkTypeCellFactoryProvider ("doublehandler", "DefaultFactoryCreate", typeof(double))]
	[GtkTypeCellFactoryProvider ("bytehandler", "DefaultFactoryCreate", typeof(byte))]
	public class MappedCellRendererSpin : CellRendererSpin, IMappedColumnItem
	{
		/// <summary>
		...
		{
			MappedCellRendererSpin wdg = new MappedCellRendererSpin();
