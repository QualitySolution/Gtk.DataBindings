...
namespace Gtk.DataBindings
{
	...
	/// how it is mapped
	/// </summary>
	[GtkCellFactoryProvider ("text", "DefaultFactoryCreate")]
	[GtkCellFactoryProvider ("string", "DefaultFactoryCreate")]
	[GtkTypeCellFactoryProvider ("stringhandler", "DefaultFactoryCreate", typeof(string))]
	public class MappedCellRendererText : CellRendererText, IMappedColumnItem
	{
		/// <summary>
