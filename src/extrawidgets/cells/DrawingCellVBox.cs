...
namespace Gtk.ExtraWidgets
{
	...
	/// </summary>
	public class DrawingCellVBox : DrawingCellPaintedBox
	{
		/// <summary>
		...
		{
			DrawingCellHelper.VBoxGetSize (this, out aWidth, out aHeight);
		}
		...
		{
			DrawingCellHelper.VBoxCalculateCellAreas (this, aRect);
		}
	}
}
